...
export function AdvancedFilterBar({
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col lg:flex-row gap-4 items-center bg-white dark:bg-gray-800 p-4 rounded-lg border dark:border-gray-700 shadow-sm">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-600 transition-colors dark:text-white"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2 items-center">
          {showStatusFilter && (
            <Select value={selectedStatus} onValueChange={handleStatusFilter}>
              <SelectTrigger className="w-32 bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 dark:text-white">
          ...
          {showCategoryFilter && (
            <Select value={selectedCategory} onValueChange={handleCategoryFilter}>
              <SelectTrigger className="w-36 bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 dark:text-white">
          ...
          <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" className="bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white">
            ...
            <DialogContent className="max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
              <DialogHeader>
                <div className="flex items-center justify-between">
                  <DialogTitle className="text-lg font-semibold text-gray-900 dark:text-white">Filters</DialogTitle>
                  <Button 
                    variant="ghost" 
                    size="sm" 
              ...
              <div className="space-y-6 py-4">
                ...
                {showAmountFilter && (
                  <div>
                    <h3 className="font-medium mb-3 text-gray-900 dark:text-white">Order Amount</h3>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-sm text-gray-600 dark:text-gray-300 mb-1 block">Min</label>
                        <Input
                          type="number"
                          placeholder="0"
                          value={minAmount}
                      ...
                      <div>
                        <label className="text-sm text-gray-600 dark:text-gray-300 mb-1 block">Max</label>
                        <Input
                          type="number"
                          placeholder="1000"
                          value={maxAmount}
                ...
                {showDateFilter && (
                  <div>
                    <h3 className="font-medium mb-3 text-gray-900 dark:text-white">Order Date</h3>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-sm text-gray-600 dark:text-gray-300 mb-1 block">Min</label>
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button variant="outline" className="w-full justify-start text-left bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:bg-gray-600">
        ...
        <div className="flex flex-wrap gap-2 items-center px-4">
          ...
          {activeFilters.map((filter) => (
            <Badge 
              key={filter} 
              variant="secondary" 
              className="bg-blue-100 text-blue-800 hover:bg-blue-200 cursor-pointer dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30"
