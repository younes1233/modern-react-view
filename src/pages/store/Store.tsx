    ...
    <div className="min-h-screen bg-white light overflow-x-hidden" data-store-page>
      <StoreLayout>
        ...
        {heroSection && heroSection.isActive && (
          <section className="relative w-full h-[70vh] md:h-[80vh] overflow-hidden z-10">
            ...
            <div className="relative z-20 h-full flex items-center rounded-md mx-0">
              <div className="w-full max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-4 md:mt-0 ml-0 md:ml-8 self-end">
                  <Button
                    size="lg"
                    className="bg-cyan-500 hover:bg-cyan-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl"
                  >
                    {heroSection.ctaText}
                  </Button>
